...
public class ScoresProvider extends ContentProvider
{
    ...
    private static final String SCORES_BY_DATE_RANGE =
            DatabaseContract.scores_table.DATE_COL + " >= ? and " + DatabaseContract.scores_table.DATE_COL + " <= ? ";
    ...
    private int match_uri(Uri uri)
    {
        String link = uri.toString();
        {
           ...
           else if(link.contentEquals(DatabaseContract.scores_table.buildScoreWithDateRange().toString()))
           {
